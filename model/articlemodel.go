...
type (
	...
	ArticleModel interface {
		...
		LogicDeleteByAuthorIDTitle(ctx context.Context, author uint64, title string) error
	}
...
func (m *customArticleModel) LogicDeleteByAuthorIDTitle(ctx context.Context, authorID uint64, title string) error {
