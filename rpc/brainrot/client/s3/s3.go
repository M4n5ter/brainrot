...
// Get presigned url
func (m *defaultS3) GetPresignedURL(ctx context.Context, in *GetPresignedURLRequest, opts ...grpc.CallOption) (*GetPresignedURLResponse, error) {
	client := brainrot.NewS3Client(m.cli.Conn())
